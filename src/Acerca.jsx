        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            ...
            <input
              ...
              className="shadow-sm border border-gray-300 text-lg rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 bg-gray-700 placeholder-gray-400 text-white focus:ring-primary-500 border-primary-500 shadow-sm-light"
            />
            <ValidationError
              prefix="Email"
              field="email"
          ...
          <div className="sm:col-span-2">
            ...
            <textarea
              ...
              rows="6"
              className="shadow-sm border border-gray-300 block p-2.5 w-full text-lg rounded-lg focus:ring-primary-500 focus:border-primary-500 bg-gray-700 placeholder-gray-400 text-white focus:ring-primary-500 border-primary-500 shadow-sm-light"
            />
            <ValidationError
              prefix="Message"
              field="message"
